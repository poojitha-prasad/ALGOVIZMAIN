...
export default function LinkedList() {
    ...
    document.title = "VisualDSA ~ Linked List";
            ...
            <div className="pt-table desktop-768">
                <div className="pt-tablecell page-home relative">
                    ...
                    <div className="overlay">
                        <div className="title">
                            <hr /><h2 className="font-weight-bold">Linked List</h2><hr />
                        </div>
                            ...
                            <div className="row">
                                <div className="hexagon-menu clear" style={hexagonMenuStyle}>
                                    <div className="hexagon-item" style={{ transform: "rotate(30deg)" }}>
                                        ...
                                        <Link className="hex-content" to='/linkedList/singlyLL'>
                                            <span className="hex-content-inner">
                                                <span className="title">Singly Linked List</span>
                                            </span>
                                    ...
                                    <div className="hexagon-item" style={{ transform: "rotate(30deg)" }}>
                                        ...
                                        <Link className="hex-content" to='/linkedList/doublyLL'>
                                            <span className="hex-content-inner">
